...
for (const file of htmlFiles) {
  ...
  html = html
    ...
    .replaceAll("기술지원 · 총판 — 오큐브(주)", "글로벌 파트너스 — 오큐브(주)")
    .replaceAll('<span aria-current="page">기술지원</span>', '<span aria-current="page">글로벌 파트너스</span>')
    .replaceAll("기술지원 · 총판", "글로벌 솔루션 · 파트너")
    .replace(/(<a href="business-license\.html">)기술지원/g, "$1글로벌 파트너스")
    .replaceAll('"name":"기술지원"', '"name":"글로벌 파트너스"')
    .replaceAll("기술지원 · 오큐브(주)", "글로벌 파트너스 · 오큐브(주)")
    .replaceAll("TECH SUPPORT", "GLOBAL PARTNER")
    .replaceAll("License Support", "Global Partners")
    .replaceAll("기술지원", "엔지니어링 지원")
    .replaceAll("기술 지원", "엔지니어링 지원")
    .replaceAll("글로벌 솔루션 · 파트너", "Global Technology Partners")
    .replaceAll("글로벌 파트너스", "Global Partners")
    .replaceAll("GLOBAL PARTNER · 총판", "GLOBAL TECHNOLOGY PARTNERS")
    .replaceAll("License &amp; Support", "Global Technology Partners")
    .replaceAll("Support Model", "Partner Delivery Model")
    .replaceAll("엔지니어링 지원 역량 보기", "글로벌 파트너 역량 보기")
    ...
    .replace(/site2\.css\?v=[^"']+/g, "site2.css?v=codex-22")
